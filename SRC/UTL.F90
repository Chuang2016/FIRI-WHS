...
!**************************************************************************************************
! 采用 Feddes (1978) 公式计算根系吸水的水分胁迫系数
!**************************************************************************************************
  IMPLICIT NONE

  ! 输出参数:
  REAL, INTENT(OUT)              :: WSR          ! 根系吸水的水分胁迫系数
  ...
  ! 局部变量:
  REAL                           :: H1           ! 厌氧点的土壤水势 (cm)
  REAL                           :: H2           ! RWUWSR = 1 的土壤水势上限
  REAL                           :: H3           ! RWUWSR = 1 的土壤水势下限
  REAL                           :: H4           ! 凋萎点的土壤水势 (cm)
...
SUBROUTINE U_KRWUS_VG1(KRWUS, H, HO, H50, P)
!**************************************************************************************************
! 采用 van Genuchten (1987) 公式计算根系吸水的水分胁迫系数
!**************************************************************************************************
  IMPLICIT NONE

  ! 输出参数:
  REAL, INTENT(OUT) :: KRWUS      ! 根系吸水的胁迫系数
  ...
  KRWUS = 1.0 / (1.0 + ((H + HO) / H50) ** P)

  RETURN
END SUBROUTINE U_KRWUS_VG1


SUBROUTINE U_KRWUS_VG2(KRWUS, H, HO, H50, HO50, P1, P2)
!**************************************************************************************************
! 采用 van Genuchten (1987) 公式计算根系吸水的水分胁迫系数
!**************************************************************************************************
  IMPLICIT NONE
  ...
  ! 输出参数:
  REAL, INTENT(OUT) :: KRWUS      ! 根系吸水的水分胁迫系数
  ...
  KRWUS = 1.0 / (1.0 + (H / H50) ** P1) + 1.0 / (1.0 + (HO / HO50) ** P2)
